...
text(Bs[,1] + xOffset, Bs[,2] + yOffset, Bs[,2], cex=0.8, pos=4, col="black")
...
As <- matrix(c(5, 10, 15, 20, 30, 0.29, 0.44, 0.55, 0.61, 0.8), 5, 2)
Bs <- matrix(c(5, 10, 15, 20, 30, 0.29, 0.44, 0.55, 0.61, 0.8), 5, 2)
Cs <- matrix(c(5, 10, 15, 20, 30, 0.19, 0.35, 0.41, 0.52, 0.74), 5, 2)
title <- "Type 1 - Questions - Categories evidences"
dataNames <- c("No weighting", "Weighting", "Maximum Similarity")
...
As <- matrix(c(5, 10, 15, 20, 30, 0.22, 0.41, 0.54, 0.66, 0.81), 5, 2)
Bs <- matrix(c(5, 10, 15, 20, 30, 0.11, 0.11, 0.11, 0.11, 0.11), 5, 2) #TODO!!!!!!!!!
Cs <- matrix(c(5, 10, 15, 20, 30, 0.2, 0.37, 0.45, 0.55, 0.76), 5, 2)
title <- "Type 3 - Answers - Categories evidences"
dataNames <- c("No weighting", "Weighting", "Maximum Similarity")
